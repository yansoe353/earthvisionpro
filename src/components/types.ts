...
export interface VolcanicEruption {
  id: string; // Unique identifier for the eruption
  name: string; // Name of the volcano
  location: { lng: number; lat: number }; // Coordinates of the eruption
  status: string; // Current status of the eruption (e.g., "ongoing")
}
